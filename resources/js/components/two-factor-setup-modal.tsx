    ...
    const modalConfig = useMemo<{
        ...
        if (twoFactorEnabled) {
            return {
                ...
                description:
                    'La autenticacion de dos factores ya esta activa. Escanea el codigo QR o ingresa la clave de configuracion en tu aplicacion autenticadora.',
                buttonText: 'Cerrar',
            };
        }
        ...
        return {
            ...
            description:
                'Para finalizar la activacion, escanea el codigo QR o ingresa la clave de configuracion en tu aplicacion autenticadora',
            buttonText: 'Continuar',
        };
